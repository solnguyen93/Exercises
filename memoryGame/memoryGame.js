...
startScreen.addEventListener('click', function (e) {
  ...
  if (
    localStorage.getItem('sliderSelectValue') == sliderSelect.value ||
    localStorage.getItem('sliderSelectValue') == null
  ) {
      ...
      if (matchedCount < sliderSelect.value / 2) {
        ...
        setTimeout(() => {
          ...
          for (let i = 0; i < COLORS.length; i++) {
            gameContainer.querySelectorAll('div')[i].style.backgroundColor =
              null;
          }

...
describe('findAll', function () {
    ...
    test('works: filter by minimum number of employees', async function () {
    ...
    test('works: filter by maximum number of employees', async function () {
    ...
    test('works: filter by name and minimum number of employees', async function () {
